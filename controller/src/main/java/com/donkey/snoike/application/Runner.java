...
public class Runner implements CommandLineRunner {
  ...
  public Runner() {
    ...
    this.snoike = new Snoike(new Rectangle(180,180, 10, 10));
    this.gameField = new GameField(new Rectangle(380, 380));
    this.gamePanel = new GamePanel(this::draw, gameField);
    this.gameFrame = new GameFrame(gamePanel);

    stonkPriceGoWheeManager.makeWhee(gameField.getBorders(), snoike);
    stonkPriceGoWheeManager.makeWhee(gameField.getBorders(), snoike);
    stonkPriceGoWheeManager.makeWhee(gameField.getBorders(), snoike);
    stonkPriceGoWheeManager.makeWhee(gameField.getBorders(), snoike);
    stonkPriceGoWheeManager.makeWhee(gameField.getBorders(), snoike);
